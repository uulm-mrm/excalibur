...
def convert_kitti_orbslam(orbslam_dir, kitti_root_dir, output_dir, frame, binary):
    # iterate sequences
...
def main():
    parser = argparse.ArgumentParser(description="Convert ORB-SLAM data of KITTI odometry in TUM format.")
    ...
    convert_kitti_orbslam(args.orbslam_dir, args.kitti_dir, args.output_dir, args.frame, args.binary)
